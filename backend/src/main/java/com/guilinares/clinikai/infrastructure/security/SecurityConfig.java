    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/admin/clinics/{clinicId}/approve").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/admin/clinics/{clinicId}/reject").permitAll()
                        .requestMatchers("/api/admin/clinics/**").authenticated()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/webhooks/n8n/**").permitAll()
